...
public class Main {
    public static void main(String[] arg) {
        ...
        // List<DamagedPostalCodes> mostDamagedPostalCodes=
        // powerService.mostDamagedPostalCodes(4);
        ...
        l2 = ps.underservedPostalByPopulation(3);

        List<String> l3 = new ArrayList<>();
        l3 = ps.underservedPostalByArea(3);
